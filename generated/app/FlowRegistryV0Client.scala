 ...
 * apidoc:0.11.6 http://localhost:9000/flow/registry/0.0.1/play_2_4_client
 */
...
package io.flow.registry.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.6 http://localhost:9000/flow/registry/0.0.1/play_2_4_client"
    val Version = "0.0.1"
    val VersionMajor = 0
