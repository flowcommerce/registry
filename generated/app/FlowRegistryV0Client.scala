 ...
 * apidoc:0.11.7 http://localhost:9000/flow/registry/0.0.9/play_2_4_client
 */
...
package io.flow.registry.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.7 http://localhost:9000/flow/registry/0.0.9/play_2_4_client"
    val Version = "0.0.9"
    val VersionMajor = 0
