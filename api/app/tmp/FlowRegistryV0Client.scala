//TODO: remove after apibuilder-generator PR is merged https://github.com/apicollective/apibuilder-generator/pull/332


/**
  * Generated by API Builder - https://www.apibuilder.io
  * Service version: 0.1.31
  * apibuilder:0.13.0 https://app.apibuilder.io/flow/registry/0.1.31/play_2_6_client
  */
package io.flow.registry.v0.models {
  ...
  object HealthcheckDiscriminator {
    ...
    case object Http extends HealthcheckDiscriminator {
      override def toString = "http"
    }

    case object Postgresql extends HealthcheckDiscriminator {
  ...
  package object json {
    ...
    implicit def jsonReadsRegistryHealthcheck: play.api.libs.json.Reads[Healthcheck] = new play.api.libs.json.Reads[Healthcheck] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[Healthcheck] = {
        (js \ "discriminator").asOpt[String].getOrElse {
          sys.error("Union[Healthcheck] requires a discriminator named 'discriminator' - this field was not found in the Json Value")
        } match {
...
package io.flow.registry.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.13.0 https://app.apibuilder.io/flow/registry/0.1.31/play_2_6_client"
    val Version = "0.1.31"
    val VersionMajor = 0
