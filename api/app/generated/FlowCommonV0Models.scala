 ...
 * apibuilder 0.14.59 app.apibuilder.io/flow/common/0.7.41/play_2_x_json
 */
...
package io.flow.common.v0 {
  ...
  object Bindables {
    ...
    object Models {
      ...
      val discountItemDiscountLocationConverter: ApibuilderTypeConverter[io.flow.common.v0.models.DiscountItemDiscountLocation] = new ApibuilderTypeConverter[io.flow.common.v0.models.DiscountItemDiscountLocation] {
        override def convert(value: String): io.flow.common.v0.models.DiscountItemDiscountLocation = io.flow.common.v0.models.DiscountItemDiscountLocation(value)
        override def convert(value: io.flow.common.v0.models.DiscountItemDiscountLocation): String = value.toString
        override def example: io.flow.common.v0.models.DiscountItemDiscountLocation = io.flow.common.v0.models.DiscountItemDiscountLocation.Item
        override def validValues: Seq[io.flow.common.v0.models.DiscountItemDiscountLocation] = io.flow.common.v0.models.DiscountItemDiscountLocation.all
      }
      implicit def pathBindableDiscountItemDiscountLocation(implicit stringBinder: QueryStringBindable[String]): PathBindable[io.flow.common.v0.models.DiscountItemDiscountLocation] = ApibuilderPathBindable(discountItemDiscountLocationConverter)
      implicit def queryStringBindableDiscountItemDiscountLocation(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[io.flow.common.v0.models.DiscountItemDiscountLocation] = ApibuilderQueryStringBindable(discountItemDiscountLocationConverter)
