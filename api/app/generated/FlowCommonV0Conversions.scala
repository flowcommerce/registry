...
package io.flow.common.v0.anorm.conversions {
  ...
  object Types {
    ...
    implicit val columnToSeqCommonDiscountItemDiscountLocation: Column[Seq[_root_.io.flow.common.v0.models.DiscountItemDiscountLocation]] = Util.parser { _.as[Seq[_root_.io.flow.common.v0.models.DiscountItemDiscountLocation]] }
    implicit val columnToMapCommonDiscountItemDiscountLocation: Column[Map[String, _root_.io.flow.common.v0.models.DiscountItemDiscountLocation]] = Util.parser { _.as[Map[String, _root_.io.flow.common.v0.models.DiscountItemDiscountLocation]] }
