 ...
 * apidoc:0.11.37 http://www.apidoc.me/flow/healthcheck/0.1.72/play_2_4_client
 */
...
package io.flow.healthcheck.v0.models {
  ...
  package object json {
    ...
    def jsObjectHealthcheck(obj: io.flow.healthcheck.v0.models.Healthcheck) = {
...
package io.flow.healthcheck.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.37 http://www.apidoc.me/flow/healthcheck/0.1.72/play_2_4_client"
    val Version = "0.1.72"
    val VersionMajor = 0
