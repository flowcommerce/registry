 ...
 * apidoc:0.11.33 http://www.apidoc.me/flow/registry/0.1.10/play_2_4_client
 */
...
package io.flow.registry.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.33 http://www.apidoc.me/flow/registry/0.1.10/play_2_4_client"
    val Version = "0.1.10"
    val VersionMajor = 0
  ...
  package errors {
    ...
    case class ErrorsResponse(
      ...
      lazy val errors = _root_.io.flow.registry.v0.Client.parseJson("Seq[io.flow.registry.v0.models.Error]", response, _.validate[Seq[io.flow.registry.v0.models.Error]])
    }
