 ...
 * User agent: apibuilder app.apibuilder.io/flow/registry/latest/play_2_8_client
 */
...
package io.flow.registry.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/flow/registry/latest/play_2_8_client"
    val Version = "0.3.41"
    val VersionMajor = 0
  ...
  class Client(
    ...
    private val logger = play.api.Logger("io.flow.registry.v0.Client")
