 ...
 * apibuilder:0.12.38 https://app.apibuilder.io/flow/registry/0.1.31/play_2_4_client
 */
...
package io.flow.registry.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.38 https://app.apibuilder.io/flow/registry/0.1.31/play_2_4_client"
    val Version = "0.1.31"
    val VersionMajor = 0
    ...
    object Applications extends Applications {
      ...
      override def post(
        ...
        _executeRequest("POST", s"/applications", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 401 => throw new io.flow.registry.v0.errors.UnitResponse(r.status)
          case r if r.status == 422 => throw new io.flow.registry.v0.errors.GenericErrorResponse(r)
