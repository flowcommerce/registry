 ...
 * apibuilder 0.14.59 app.apibuilder.io/flow/common/0.7.41/anorm_2_6_parsers
 */
import anorm._
...
package io.flow.common.v0.anorm.parsers {
  ...
  object DiscountItemDiscountLocation {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.flow.common.v0.models.DiscountItemDiscountLocation] = parser(prefixOpt = Some(s"$prefix$sep"))

    def parser(name: String = "discount_item_discount_location", prefixOpt: Option[String] = None): RowParser[io.flow.common.v0.models.DiscountItemDiscountLocation] = {
      SqlParser.str(prefixOpt.getOrElse("") + name) map {
        case value => io.flow.common.v0.models.DiscountItemDiscountLocation(value)
      }
    }
  ...
  object DiscountForm {
    ...
    def parser(
      ...
      io.flow.common.v0.anorm.parsers.DiscountItemDiscountLocation.parser(prefixOpt.getOrElse("") + location) map {
        case offer ~ target ~ label ~ location => {
