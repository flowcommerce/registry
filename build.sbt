...
lazy val api = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      guice,
      jdbc,
      "io.flow" %% "lib-postgresql-play-play26" % "0.3.30",
      "io.flow" %% "lib-play-graphite-play26" % "0.0.97",
      "com.typesafe.play" %% "play-json-joda" % "2.6.10",
      "org.postgresql" % "postgresql" % "42.2.5",
      "net.jcazevedo" %% "moultingyaml" % "0.4.0",
      "io.flow" %% "lib-test-utils" % "0.0.52" % Test,
      "io.flow" %% "lib-usage" % "0.0.95",
      "io.flow" %% "lib-log" % "0.0.72",
