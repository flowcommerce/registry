...
lazy val api = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      guice,
      jdbc,
      "io.flow" %% "lib-postgresql-play-play26" % "0.3.45",
      "io.flow" %% "lib-play-graphite-play26" % "0.1.4",
      "com.typesafe.play" %% "play-json-joda" % "2.6.10",
      "org.postgresql" % "postgresql" % "42.2.5",
      "net.jcazevedo" %% "moultingyaml" % "0.4.0",
      "io.flow" %% "lib-test-utils" % "0.0.62" % Test,
      "io.flow" %% "lib-usage" % "0.1.3",
      "io.flow" %% "lib-log" % "0.0.79",
